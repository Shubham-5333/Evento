        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pb-8 border-b border-slate-100">
            ...
            <div className="text-center sm:text-left space-y-1">
              ...
              <p className="text-xs text-slate-500 font-medium">Member since {mockUser.joinedDate || '2026'}</p>
          ...
          <form onSubmit={handleSave} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="sm:col-span-2 space-y-1.5">
                <label className="text-xs font-bold text-slate-700 uppercase tracking-wider block">Bio & Preferences</label>
                <textarea
                  rows={3}
                  value={bio}
                  onChange={(e) => setBio(e.target.value)}
                  className="w-full p-3.5 bg-slate-50 border border-slate-200 focus:border-blue-500 rounded-xl text-sm font-medium focus:outline-none text-slate-900 resize-none"
                />
              </div>
